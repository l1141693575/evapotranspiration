...
*/
@FeignClient(name = "mycloud-order-provider", fallback = EssentialClientFallBack.class)
public interface RestEssentialClient {
@RequestMapping(value = "/getEssentialById",method = RequestMethod.POST)
public Essential getEssentialById(@RequestParam("id") Long id)throws Exception;
