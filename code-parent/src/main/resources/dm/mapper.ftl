...
<mapper namespace="com.zb.mapper.${table.className}Mapper">

    <select id="get${table.className}ById" resultType="com.zb.pojo.${table.className}">
        select
    ...
    <select id="get${table.className}ListByMap" resultType="com.zb.pojo.${table.className}" parameterType="java.util.Map">
        select
        <#list table.cloumns as cloumn>
            <#if cloumn_has_next>
                ${cloumn.cloumnName} as ${cloumn.fieldName},
    ...
    <insert id="insert${table.className}" parameterType="com.zb.pojo.${table.className}">
    ...
    <update id="update${table.className}" parameterType="com.zb.pojo.${table.className}">
